// VISIBILIDAD DE ENTRADAS (fuente unica para ES + EN)
//
// Para OCULTAR una entrada en AMBOS idiomas, agrega su `postId` a esta lista.
...
// Devuelve true si la entrada debe mostrarse (no esta en draft ni oculta por postId).
